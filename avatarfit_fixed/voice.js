...
const VOICE_COMMANDS = [
  ...
  { match: ['squat', 'squats'],                 action: () => { if (typeof workoutMode !== 'undefined' && workoutMode) exitWorkoutMode(); startExercise('squat');  speak('Starting squat'); } },
  { match: ['curl', 'bicep curl', 'curls'],      action: () => { if (typeof workoutMode !== 'undefined' && workoutMode) exitWorkoutMode(); startExercise('curl');   speak('Starting bicep curl'); } },
  { match: ['lunge', 'lunges'],                  action: () => { if (typeof workoutMode !== 'undefined' && workoutMode) exitWorkoutMode(); startExercise('lunge');  speak('Starting lunge'); } },
  { match: ['plank'],                            action: () => { if (typeof workoutMode !== 'undefined' && workoutMode) exitWorkoutMode(); startExercise('plank');  speak('Starting plank'); } },
